...
[← Previous: Module 2]({{ "/module-2-where-the-data-comes-from/" | relative_url }}) · [Back to course overview]({{ "/" | relative_url }}){: .mx-4 } · [Next: Module 4 →]({{ "/module-4-the-business-layer/" | relative_url }})
