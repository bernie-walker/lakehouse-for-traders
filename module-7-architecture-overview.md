...
[← Previous: Module 6]({{ "/module-6-governance-lineage-master-data/" | relative_url }}) · [Back to course overview]({{ "/" | relative_url }}){: .mx-4 } · [Next: Module 8 →]({{ "/module-8-sql-primer/" | relative_url }})
